...
| [`template-improvement-review`](template-improvement-review/README.md) | Fresh-eyes review of the template + pooled improvement program over every open thread | Complete pending merge (session 2, 2026-09-10): cards M27/M28/M29/L38/L39 archived, L45 filed, fresh-eyes fixes C2–C12 landed on `review/template-improvement-review-s1`; user-only items in its `review.md` §E |
