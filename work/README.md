...
| [`template-improvement-review`](template-improvement-review/README.md) | Fresh-eyes review of the template + pooled improvement program over every open thread | Active — session 1 (2026-09-10): housekeeping fixes, design-gap cards being built |
| [`template-maintenance`](template-maintenance/README.md) | Umbrella for ongoing template upkeep (backlog, skill syncs) | Standing — blocked on user direction for the 5 open cards (options brief); `template-improvement-review` is working them under stated assumptions |
