...
|---|---|---|---|---|---|---|---|---|
| 0 | Live chain ended; relaunch default manual + per-item auto; counter import | in progress | 1 | 1 | 2026-09-16 | | | chain ended session 10 (quit with nothing staged); tasks 2–5 done, see plans/phase-0.md |
